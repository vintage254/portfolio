...
const Hero = () => {
  ...
  const applyCharStyles = (element: HTMLElement) => {
    element.style.display = 'inline-block';
    element.style.background = "url('/herobg/herobg.jpg') center";
    element.style.backgroundSize = "cover";
    element.style.backgroundClip = "text";
    element.style.webkitBackgroundClip = "text";
    element.style.color = "transparent";
    element.style.animation = "animate 10s linear infinite";
  };
  ...
  return (
    ...
    >
      <style jsx>{`
        ...
        .animated-text-bg {
          background: url('/herobg/herobg.jpg') center;
            ...
            <div className="mb-6">
              <div className="flex flex-col">
                <SplitText
                  ...
                  rootMargin="0px"
                  textAlign="left"
                  onLetterAnimationComplete={() => console.log('First line animated!')}
                  applyCharStyles={applyCharStyles}
                />
                <SplitText
                  text="I'm Derrick Njuguna"
                  className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold"
                  delay={50}
                  duration={0.4}
                  ease="power2.out"
