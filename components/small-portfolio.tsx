    ...
    <section id="portfolio" className="py-20 bg-black text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-20 p-3 bg-gray-800/80 backdrop-blur-sm rounded-full text-white hover:bg-blue-500 transition-colors duration-300 -ml-6"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-20 p-3 bg-gray-800/80 backdrop-blur-sm rounded-full text-white hover:bg-blue-500 transition-colors duration-300 -mr-6"
          >
        ...
        >
          <motion.a
            href="/portfolio"
            className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-full hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 group text-sm sm:text-base"
